...
shinyUI(fluidPage(
  fluidRow(
    column(3,
           wellPanel(
             selectInput("response","Network measure",choices=list("Link density" = "LD", "Species (nodes)" = "N","Links" = "Ltot","Connectance" = "C", "Nestedness" = "Nestedness","Compartmentalization" = "Cbar","Trophic levels" = "Trophic_levels"),selected = "LD"),
             ...
             radioButtons("contrast","Contrast (pixel with white outline)",choices = list("Same patch"= 0,"Same climate" = 50),selected = 50),
